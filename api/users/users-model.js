...
function find() {
  return db('users').join('roles', 'users.role_id', 'roles.role_id').select('user_id', 'role_name', 'username')
...
function findBy(filter) {
  ...
  return db('users').join('roles', 'users.role_id', 'roles.role_id').select('user_id', 'role_name', 'username', 'password').where(filter)
